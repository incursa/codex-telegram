...
builder.Services.AddSingleton<IGitWorktreeProvisioner, GitWorktreeProvisioner>();
...
builder.Services.AddHostedService<TelegramBotMetadataSyncService>();
builder.Services.AddHostedService<CodexWarmupHostedService>();
builder.Services.AddHostedService<TelegramLaunchpadExpirationHostedService>();
