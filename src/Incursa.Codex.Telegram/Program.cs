...
builder.Services.AddSingleton<CodexAccountUsageHistoryStore>();
builder.Services.AddHostedService<CodexAccountUsageSamplerHostedService>();
builder.Services.AddSingleton<CodexGlobalInstructionsStore>();
builder.Services.AddSingleton<ICodexGlobalInstructionsStore>(sp => sp.GetRequiredService<CodexGlobalInstructionsStore>());
